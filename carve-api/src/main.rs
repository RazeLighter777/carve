                ...
                web::scope("/api/v1")
                    .service(
                        web::scope("/competition")
                            ...
                            .service(teams::add_support_ticket_message)
                            .service(teams::get_support_ticket)
                            .service(teams::get_team_support_tickets)
                            .service(teams::create_support_ticket)
                            .service(teams::update_support_ticket_status)
